...
// const strings
var CONST_STRINGS = require('./support/CONST_STRINGS.js');

var isAdminAuthorized = require('./support/verify-admin.js');
    ...
    function onConnection(socket) {
       ...
       // params.userid = "gorgomish"
        ...
        socket.on('disconnect', function() {
            console.log("THIS IS DISCCONEECTEDING THE THING")
